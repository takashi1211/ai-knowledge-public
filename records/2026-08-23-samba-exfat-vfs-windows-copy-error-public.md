...
- `catia`、`fruit`、`streams_xattr` を個別に外した場合の比較
- Macからfruit有効・無効の共有を同時利用した場合の挙動
- exFAT以外のファイルシステムで同じ症状と修正が再現するか
...
- [x] 未検証を明記した
- [x] 元記録との関係を記載した
- [x] 読み物へ過度に再構成せず、作業・検証記録の役割を保った

## 変更履歴

- 2026-08-23：初版作成
- 2026-08-26：未検証項目と公開前チェックを追加
